    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/client/add", "/client/", "/client/test", "/client/get", "/angajati/add", "/api/auth/login", "/api/auth/register").permitAll() // Permite accesul public pentru aceste rute

...
//aceasta este clasa pentru tabela masini cu toate campurile ei
@Entity
public class Masini {
    ...
    @OneToMany(mappedBy = "idMasina", cascade = CascadeType.ALL, orphanRemoval = true)
    private List<Reparatii> reparatii = new ArrayList<>();
